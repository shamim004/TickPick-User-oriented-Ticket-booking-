...
if ($result->num_rows > 0) {
 ...
 ?>       
					...
					<div class="row flexbox-center">
						<div class="col-lg-5 text-lg-left text-center">
							<div class="transformers-content">
								<img src="http://www.dizitechbd.com/tickpick/buy/admin/pages/datatable/Sports/upload/<? echo $row['image']; ?>" alt="about" />
							</div>
						</div>
						<div class="col-lg-7">
							<div class="transformers-content">
								<h2> <? echo $row["sports_name"]; ?></h2>
								<p>Cricket | Football | Tennis | Olympic</p>
								<ul>
									<li>
					...
					<a href="https://dizitechbd.com/tickpick/buy/sports/index.html" class="theme-btn"><i class="icofont icofont-ticket"></i> BUY TICKET</a>
				</div>
<?       
    }
} else {
