			...
			<div class="container">
				<div class="hero-area-slider">
					<div class="row hero-area-slide">
						...
						<div class="col-lg-6 col-md-7">
							<div class="hero-area-content pr-50">
								...
								<p>Super-assassin John Wick is on the run after killing a member of the international assassin's guild, and with a $14 million price tag on his head - he is the target of hit men and women everywhere....</p>
								<h3>Cast:</h3>
					...
					<div class="row hero-area-slide">
						<div class="col-lg-6 col-md-5">
							<div class="hero-area-content">
								<img src="assets/img/slide1.jpg" alt="about" />
							</div>
						</div>
						<div class="col-lg-6 col-md-7">
							<div class="hero-area-content pr-50">
								...
								<p>Eight years after the Joker's reign of anarchy, Batman, with the help of the enigmatic Catwoman, is forced from his exile to save Gotham City, now on the edge of total annihilation, from the brutal guerrilla terrorist Bane....</p>
								<h3>Cast:</h3>
								<div class="slide-cast">
									<div class="single-slide-cast">
										<img src="assets/img/cast/cast1.png" alt="about" />
					...
					<div class="row hero-area-slide">
						<div class="col-lg-6 col-md-5">
							<div class="hero-area-content">
								<img src="assets/img/slide3.jpg" alt="about" />
							</div>
						</div>
						<div class="col-lg-6 col-md-7">
							<div class="hero-area-content pr-50">
								...
								<p>Ayna is an actor and the prison is his stage. He slips into the characters of the powerful convicted in exchange of money and take their place in prison. This strange profession is borne ...</p>
								<h3>Cast:</h3>
								<div class="slide-cast">
									<div class="single-slide-cast">
										<img src="assets/img/cast/cast1.png" alt="about" />
...
if ($conn->connect_error) {
    ...
    $db = mysqli_select_db($conn, "dizitech_tickpick") or die("Error " . mysqli_error());

   $sql = mysqli_query($conn, "SELECT * FROM movies ORDER BY `id` DESC");
					...
					<div class="col-md-4 col-sm-6 soon released">
								<div class="single-portfolio">
									<div class="single-portfolio-img">
										<img src="http://www.dizitechbd.com/tickpick/buy/admin/pages/datatable/Movies/upload/<? echo $row['image']; ?>" alt="portfolio" />
										<a href=" <? echo $row["trailer_link"]; ?>" class="popup-youtube">
											<i class="icofont icofont-ui-play"></i>
										</a>
									</div>
									<div class="portfolio-content">
										<a href="http://tickpick.xyz/movie_details.php?movie_id=<? echo $row['id']; ?>"><h2> <? echo $row["movie_name"]; ?></h2></a>
										<div class="review">
											<div class="author-review">
												<i class="icofont icofont-star"></i>
												<i class="icofont icofont-star"></i>
				...
				<div class="row">
                    <div class="col-md-9">
						<div class="video-area">
							...
							<a href="https://www.youtube.com/watch?v=K-jqUUD8R2g" class="popup-youtube">
								<i class="icofont icofont-ui-play"></i>
							</a>
						...
						<div class="row">
							<div class="col-md-12 col-sm-6">
								<div class="video-area">
									...
									<a href="https://www.youtube.com/watch?v=g8evyE9TuYk" class="popup-youtube">
										<i class="icofont icofont-ui-play"></i>
									</a>
								</div>
							</div>
							<div class="col-md-12 col-sm-6">
								<div class="video-area">
									...
									<a href="https://www.youtube.com/watch?v=pU8-7BX9uxs" class="popup-youtube">
										<i class="icofont icofont-ui-play"></i>
									</a>
								</div>
							</div>
