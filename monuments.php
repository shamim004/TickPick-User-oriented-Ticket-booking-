...
$sql = "SELECT * FROM monuments ORDER BY `id` DESC";
 ...
 ?>       
						...
						<div class="single-portfolio">
							<div class="single-portfolio-img">
								<img src="http://dizitechbd.com/tickpick/buy/admin/pages/datatable/Monuments/upload/<? echo $row['image']; ?>" alt="portfolio" />
								
							</div>
							<div class="portfolio-content">
								<a href="http://tickpick.xyz/monument_details.php?monuments_id=<? echo $row['id']; ?>"><h2> <? echo $row["monuments_name"]; ?></h2></a>
								<div class="review">
