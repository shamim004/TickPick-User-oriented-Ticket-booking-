        ...
        function () {
            if (!$(this).hasClass("seatUnavailable")){
                ...
                if ($(this).hasClass("seatSelected")) {
                    ...
                    var seatDetails = "Row: " + id[0] + " Seat:" + id[1] + " Price:Tk.:" + price;
                    ...
                    var seatDetails = "Row: " + id[0] + " Seat:" + id[1] + " Price:Tk.:" + price;
                    $("#seatsList").append('<div value=' + price + ' class=' + thisId + '>' + seatDetails + "  " + "<button id='remove:" + thisId + "'+ class='btn btn-default btn-sm removeSeat' value='" + price + "'><strong>X</strong></button></div>");
    ...
    $(".seatNumber").hover(
        function () {
            if (!$(this).hasClass("seatUnavailable")) {
                ...
                var id = id.split("_");
                var price = $(this).attr('value');
                var tooltip = "Row: " + id[0] + " Seat:" + id[1] + " Price:Tk.:" + price;
