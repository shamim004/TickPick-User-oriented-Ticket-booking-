					...
					<div class="row flexbox-center">
						<div class="col-lg-5 text-lg-left text-center">
							<div class="transformers-content">
								<img src="http://www.dizitechbd.com/tickpick/buy/admin/pages/datatable/Monuments/upload/<? echo $row['image']; ?>" alt="about" />
							</div>
						</div>
						<div class="transformers-content">
